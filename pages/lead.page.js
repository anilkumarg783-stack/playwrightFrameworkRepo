class lead {
    constructor(page) {
        ...
        this.leadSelectAllCheckbox = page.locator('//input[@name="selectall" and @id="selectCurrentPageRec"]')
        ...
        this.leadSearchHeaderText = page.getByText('Showing Records').first()
        this.leadRecordCheckbox = page.locator('//span[contains(text(),"No Lead Found !")]')
        this.leadSearchHeaderCnt = page.locator('(//td[contains(text(),"Showing Records 1 - 2 of 2")])[1]')
